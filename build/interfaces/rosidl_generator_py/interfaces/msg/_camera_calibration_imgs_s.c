...
bool interfaces__msg__camera_calibration_imgs__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._camera_calibration_imgs.CameraCalibrationImgs", full_classname_dest, 61) == 0);
  }
  interfaces__msg__CameraCalibrationImgs * ros_message = _ros_message;
  {  // imgs
    ...
    sensor_msgs__msg__Image * dest = ros_message->imgs.data;
...
{
  /* NOTE(esteve): Call constructor of CameraCalibrationImgs */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._camera_calibration_imgs");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraCalibrationImgs");
