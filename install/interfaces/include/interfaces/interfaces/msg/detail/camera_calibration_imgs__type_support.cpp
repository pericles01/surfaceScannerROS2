...
void fetch_function__CameraCalibrationImgs__imgs(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const sensor_msgs::msg::Image *>(
    get_const_function__CameraCalibrationImgs__imgs(untyped_member, index));
  auto & value = *reinterpret_cast<sensor_msgs::msg::Image *>(untyped_value);
  value = item;
}

void assign_function__CameraCalibrationImgs__imgs(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<sensor_msgs::msg::Image *>(
    get_function__CameraCalibrationImgs__imgs(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CameraCalibrationImgs_message_member_array[1] = {
  {
    ...
    fetch_function__CameraCalibrationImgs__imgs,  // fetch(index, &value) function pointer
    assign_function__CameraCalibrationImgs__imgs,  // assign(index, value) function pointer
