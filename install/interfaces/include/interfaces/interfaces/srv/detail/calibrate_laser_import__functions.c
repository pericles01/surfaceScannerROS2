...
interfaces__srv__CalibrateLaserImport_Request__create()
{
  ...
  interfaces__srv__CalibrateLaserImport_Request * msg = (interfaces__srv__CalibrateLaserImport_Request *)allocator.allocate(sizeof(interfaces__srv__CalibrateLaserImport_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__srv__CalibrateLaserImport_Request__Sequence__init(interfaces__srv__CalibrateLaserImport_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__srv__CalibrateLaserImport_Request *)allocator.zero_allocate(size, sizeof(interfaces__srv__CalibrateLaserImport_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__srv__CalibrateLaserImport_Request__Sequence * array = (interfaces__srv__CalibrateLaserImport_Request__Sequence *)allocator.allocate(sizeof(interfaces__srv__CalibrateLaserImport_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  interfaces__srv__CalibrateLaserImport_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__srv__CalibrateLaserImport_Request * data =
      (interfaces__srv__CalibrateLaserImport_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__srv__CalibrateLaserImport_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__srv__CalibrateLaserImport_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__srv__CalibrateLaserImport_Response * msg = (interfaces__srv__CalibrateLaserImport_Response *)allocator.allocate(sizeof(interfaces__srv__CalibrateLaserImport_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__srv__CalibrateLaserImport_Response__Sequence__init(interfaces__srv__CalibrateLaserImport_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__srv__CalibrateLaserImport_Response *)allocator.zero_allocate(size, sizeof(interfaces__srv__CalibrateLaserImport_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__srv__CalibrateLaserImport_Response__Sequence * array = (interfaces__srv__CalibrateLaserImport_Response__Sequence *)allocator.allocate(sizeof(interfaces__srv__CalibrateLaserImport_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  interfaces__srv__CalibrateLaserImport_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces__srv__CalibrateLaserImport_Response * data =
      (interfaces__srv__CalibrateLaserImport_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__srv__CalibrateLaserImport_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__srv__CalibrateLaserImport_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
